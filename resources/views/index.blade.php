...
<html>
  ...
  <body>
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
            ...
            <div class="offcanvas-body">
              <ul id="navbar"
                ...
                <li class="nav-item">
                  <a class="nav-link me-4 active" href="{{ route(Auth::user()->role . '.dashboard')}}">Dashboard</a>
                </li>
                {{-- <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link me-4" href="">Dasboard</a>
                </li>
                ...
                <li class="nav-item">
                  <a class="nav-link me-4" href="{{$menu->menu_link}}">{{$menu->menu_name}}</a>
                </li>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                              <div class="tab-pane fade active show" id="nav-sign-in" role="tabpanel"
                                aria-labelledby="nav-sign-in-tab">
                                  <form  action="/ProsesLogin" method="POST" class="pt-3">
                                  @csrf
                                  <div class="form-group">
                                      <input type="text" class="form-control form-control-lg" name="email" id="email" placeholder="Masukkan Email">
                                  </div>
                                  <div class="form-group">
                                      <input type="password" class="form-control form-control-lg" name="password" id="password" placeholder="Masukkan Password">
                                  </div>
                                  <div class="mt-3 d-grid gap-2">
                                      <input class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit"></input>
                                      @error('email')
                              ...
                              <div class="tab-pane fade" id="nav-register" role="tabpanel"
                                ...
                                <form  action="/ProsesSimpan" method="POST" class="pt-3">
                                  @csrf
                                  <div class="form-group">
                                  <input type="text" class="form-control form-control-lg" name="nama" id="nama" placeholder="Masukkan Nama">
                              </div>
                              <div class="form-group">
                                  <input type="text" class="form-control form-control-lg" name="email" id="email" placeholder="Masukkan Email">
                              </div>
    ...
    <section id="company-services" class="padding-large pb-0">
      <div class="container">
        <div class="row">
          <h1 style="text-align: center">Welcome <br>to My Library</h1>
        </div>
      </div>
    </section>
    ...
    <section id="best-selling-items" class="position-relative padding-large ">
      <div class="container">
        <div class="section-title d-md-flex justify-content-between align-items-center mb-4">
          <h3 class="d-flex align-items-center">List Books</h3>
          <a href="{{ route('buku.input')}}" class="btn">View All</a>
        </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="card position-relative p-4 border rounded-3">
                <h6 class="mt-4 mb-0 fw-bold"><a href=""></a>{{ $item->judul }}</h6>
                <div class="review-content d-flex">
                  <p class="my-2 me-2 fs-6 text-black-50">{{ $item->pengarang }}</p>
                </div>
              </div>
            </div>
            @endforeach
